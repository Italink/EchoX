#ifndef QWidgetCloseVFX_FadeOut_h__
#define QWidgetCloseVFX_FadeOut_h__

#include "IWidgetVFX.h"
#include "Settings/IEchoXSettings.h"

class QWidgetCloseVFX_FadeOut : public IWidgetCloseVFX {
	Q_OBJECT
...
#endif // QWidgetCloseVFX_FadeOut_h__