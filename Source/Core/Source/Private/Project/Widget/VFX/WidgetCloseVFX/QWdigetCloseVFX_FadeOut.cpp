...
//}
//
//void QWdigetCloseVFX_FadeOut::play(float timeSec, const QRhiViewport& viewport, QRenderGraphBuilder& builder)
//{
...
//	builder.addPass([this, &builder, timeSec, viewport](QRhiCommandBuffer* cmdBuffer) {
